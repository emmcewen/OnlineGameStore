        ...
        <CardFooter divider className="flex items-center justify-between py-3">
          ...
          <Typography variant="small" color="gray" className="flex gap-1">
            ...
            <div className='addtocart'>
              <button className='addtocartbtn mr-20'>Add to cart<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
